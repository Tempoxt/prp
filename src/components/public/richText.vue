<template>
  <div id="app">
    ...
    <vue-tinymce
      v-model="content" 
      :setting="setting" />
      <el-button @click="getContent">点我</el-button>
  </div>
</template>
  ...
  data(){
    return {
      ...
      setting: {
        ...
        toolbar: "undo redo | print | fullscreen | formatselect alignleft aligncenter alignright alignjustify | link unlink | numlist bullist | image media table | fontselect fontsizeselect forecolor backcolor | bold italic underline strikethrough | indent outdent | superscript subscript | removeformat |",
        toolbar_drawer: "sliding",
        quickbars_selection_toolbar: "removeformat | bold italic underline strikethrough | fontsizeselect forecolor backcolor",
        plugins: "link image media table lists fullscreen quickbars code print",
